...
@Component({
  ...
  <div class="flex items-end justify-between">
    ...
    <app-badge 
      variant="light"
      [color]="getBadgeColor(changeDirection)"
      [startIcon]="getArrowIcon(changeDirection)"
    >
      {{ change }}
    </app-badge>
  </div>
