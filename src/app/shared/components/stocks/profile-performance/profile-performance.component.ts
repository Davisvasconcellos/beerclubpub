...
// import { ApexAxisChartSeries, ApexChart, ApexXAxis, ApexDataLabels, ApexStroke, ApexMarkers, ApexYAxis, ApexLegend, ApexTooltip, ApexFill, ApexGrid, ApexOptions, NgApexchartsModule } from 'ng-apexcharts';
...
import { Component } from '@angular/core';
import {
  ApexAxisChartSeries, ApexChart, ApexFill, ApexStroke, ApexMarkers, ApexGrid,
  ApexDataLabels, ApexTooltip, ApexXAxis, ApexYAxis, ApexLegend,
  NgApexchartsModule
} from 'ng-apexcharts';
import { ChartTabComponent } from '../../common/chart-tab/chart-tab.component';
...
export class ProfilePerformanceComponent {
  ...
  public stroke: ApexStroke = { curve: "straight", width: [1] };
